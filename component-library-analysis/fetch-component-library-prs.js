...
console.log('🔍 Fetching PRs from component-library');
...
async function fetchPRs(page = 1) {
  return new Promise((resolve, reject) => {
    const options = {
      ...
      path: `/repos/department-of-veterans-affairs/component-library/pulls?state=all&per_page=100&page=${page}`,
      headers: {
...
(async () => {
  try {
    ...
    // Save to file
    fs.writeFileSync('component-library-prs-2025-2026.json', JSON.stringify(prs, null, 2));
    console.log('📁 Saved to: component-library-prs-2025-2026.json\n');
